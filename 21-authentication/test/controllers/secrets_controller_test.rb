...
class SecretsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create secret" do
    assert_difference('Secret.count') do
      post secrets_url, params: { secret: { author_id: @secret.author_id, text: @secret.text } }
    end
  ...
  test "should update secret" do
    patch secret_url(@secret), params: { secret: { author_id: @secret.author_id, text: @secret.text } }
